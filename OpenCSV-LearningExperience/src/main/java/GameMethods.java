...
public class GameMethods {
    ...
    public static boolean checkersForNextWord(List<String> list, String name1, String name2){
    ...
    public static String checkersForFirstWordString(List<String> list, String name1,  int n) {
        ...
        if (!GameMethods.checkForSameLength(name1, n)) {
    ...
    public static boolean checkForSameLength(String name1, int n){
        return name1.length() == n;
    }

    public static boolean checkIfInDictionary(List<String> list, String name){
